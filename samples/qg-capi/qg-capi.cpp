...
int main(int argc, char **argv) {
  ...
  std::cerr
      << "  curl -L -O "
         "https://github.com/yahoojapan/NGT/raw/main/tests/datasets/ann-benchmarks/sift-128-euclidean.tsv"
      << std::endl;
  std::cerr << "  curl -L -O "
               "https://github.com/yahoojapan/NGT/raw/main/tests/datasets/ann-benchmarks/"
               "sift-128-euclidean_query.tsv"
            << std::endl;
